...
public class PlaySurfaceView extends SurfaceView implements
        ...
        try {
            ...
            mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(final MediaPlayer mediaPlayer) {
                    ...
                    setFullScreen();
                    mediaPlayer.start();
                    if (listener != null) listener.onVideoSize(mediaPlayer.getDuration());
                    new Thread() {
                        @Override
                        public void run() {
                            try {
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        isPlay = false;
        if (listener != null) listener.onPlayOver();
    }
