package com.example.flutter_app.widget;
...
import com.example.flutter_app.alirtc.util.DisplayUtil;
...
public class CircleCountDownView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        int circleImgSrc = typedArray.getResourceId(R.styleable.CircleCountDownView_circleImgSrc, R.mipmap.ic_sign_in);
//        circleImgBitmap = ImageUtil.cropSquareBitmap(BitmapFactory.decodeResource(getResources(), circleImgSrc));
        ...
        valueTextPaint.setTextSize(typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_valueTextSize, DisplayUtil.dp2px(20)));
